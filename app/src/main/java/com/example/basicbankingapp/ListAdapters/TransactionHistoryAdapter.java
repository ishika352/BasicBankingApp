...
import com.example.basicbankingapp.Transaction;
...
public class TransactionHistoryAdapter extends RecyclerView.Adapter<TransactionHistoryAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ...
        if (transactionArrayList.get(position).getStatus() == 1) {
            viewHolder.cardView.setCardBackgroundColor(Color.argb(100, 255, 27, 195));
        }
        else {
            viewHolder.cardView.setCardBackgroundColor(Color.argb(100, 189, 100, 100));
        }
    }
